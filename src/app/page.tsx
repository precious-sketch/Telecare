      ...
      : 'bg-[#efe1cd]'
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-6xl mx-auto">
          {testimonial.map((res, i) => (
            <div key={i} className={`${theme==='dark'?'bg-[#71583c]':'bg-[#efe1cd] '} shadow-md p-4`}>
...
// if (!mounted) return null;
//   return (
//     <div className={`${theme==='dark'?'bg-[#71583c] text-white':'bg-[#efe1cd] text-[#71583c]'} flex items-center justify-center bg-cover bg-fixed w-full  max-md:pt-16 pt-24   relative overflow-x-hidden`}>
...
//             required
//             className='w-full outline-0 border p-1 px-3 text-white bg-[#71583c]/40 border-[#71583c]/50  focus:border-white/60  font-light text-lg'
//           />
//         </div>
...
//             onChange={handleChange}
//             required
//             className='w-full outline-0 border p-1 px-3 text-white bg-[#71583c]/40 active:bg-[#71583c]/25 focus:border-white/60 border-[#71583c]/50  font-light text-lg'
//           />
//         </div>
//         <div className='w-full flex flex-row pt-3  gap-1 text-md align-middle items-center max-md:flex-col max-md:gap-0'>
...
//             required
//             rows={2}
//             className='w-full outline-0 border p-1 px-3 text-white  border-[#71583c]/50 bg-[#71583c]/40 focus:border-white/60  active:bg-[#71583c]/25  font-light text-lg'
//           />
//         </div>
...
//       </form>
//       <div className="w-full flex flex-row flex-wrap space-y-2 p-5 space-x-2 align-start justify-start items-start text-wrap border-t-2 border-[#71583c]/25">
