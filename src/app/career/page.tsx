...
const Page = () => {
  ...
  return (
    <div className={`w-full py-32  px-[3%] space-y-5 ${theme==='dark'?'bg-[#71583c] text-white border-white':"bg-[#efe1cd] text-[#71583c] border-[#71583c]"}`}>
...
<div className={`p-1.5 text-center flex items-center ${theme==='dark'?'bg-[#efe1cd] text-[#71583c]':'bg-[#71583c] text-white'}  border`}>View all</div>
