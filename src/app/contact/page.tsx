    ...
    theme === 'dark'
      ...
      : 'text-[#644b2e] bg-[#efe1cd]'
        ...
        theme === 'dark' ? 'text-white' : 'text-black'
         ...
         <div className={`w-[94%] mx-auto max-md:max-w-[500px] mt-20 md:flex-row  max-md:flex-col shadow-lg z-10  backdrop-blur-sm flex flex-row flex-wrap ${theme==='dark'?' text-neutral-100 bg-[#50391e]':' text-neutral-950 bg-[#fff9f0]'} `}>
      ...
      <div className='text-2xl max-md:text-xl align-middle flex items-center   w-fit h-fit bebas tracking-wider leading-snug font-semibold'>Message Us</div>
        <div className='w-full flex flex-row flex-wrap pt-5  gap-1 text-md align-middle items-center  max-md:gap-0'>
          ...
          <input
            ...
            required
            className={`w-full min-w-32 outline-0 p-1 px-3  ${theme==='dark'?'text-[#fff9f0] border-[#fff9f0]':'border-[#50391e] text-[#50391e]'} border focus:border-2  font-light text-lg`}
          />
        </div>
