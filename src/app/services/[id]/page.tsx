...
import React, { useState } from 'react';
 const services = [
  ...
  },
  {
    ...
    "content_paragraphs": [
      "We believe in tailoring our support to meet the unique requirements of each resident, fostering independence while providing the necessary care and assistance. Our dedicated team of professionals ensures round-the-clock support, creating a safe and enriching space that encourages personal growth and community integration.",
      "With a focus on personalized care plans, specialized support, and a commitment to promoting autonomy, our Adult Residential Services strive to enhance the quality of life for individuals with special needs. We aim to create a home where residents feel valued, respected, and empowered to lead fulfilling lives.",
...
const Page = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  return (
 <section className= {`w-full py-24 text-justify ${theme==='dark'?'bg-[#432400] text-white':'bg-gray-100 text-[#432400]'}`}>
  <ServiceComp id={id}/>
</section>
  );
};
